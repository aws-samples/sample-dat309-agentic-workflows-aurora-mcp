...
PHASE_CATALOG: Dict[int, PhaseSpec] = {
    ...
    4: PhaseSpec(
        ...
        skills=(
            ...
            SkillSpec("recall_session_context", "TravelerMemoryAgent", "recall_session_context(conversation_id, limit=6)", "agents/phase4/memory_agent.py"),
            SkillSpec("recall_traveler_preferences", "TravelerMemoryAgent", "recall_traveler_preferences(traveler_id, limit=8)", "agents/phase4/memory_agent.py"),
            SkillSpec("recall_similar_interactions", "TravelerMemoryAgent", "recall_similar_interactions(traveler_id, query, limit=3)", "agents/phase4/memory_agent.py"),
            SkillSpec("persist_turn", "TravelerMemoryAgent", "persist_turn(...)", "agents/phase4/memory_agent.py"),
        ),
    ),
    5: PhaseSpec(
        phase=5,
